...
import { getCars, getCar, createCar, updateCar, deleteCar, searchCars, reorderCars, resolveCarSlug } from "../controllers/carController.js";
import { protect } from "../middleware/authMiddleware.js";
const router = express.Router();

router.get("/search", searchCars);
router.get("/resolve/:id", resolveCarSlug);
